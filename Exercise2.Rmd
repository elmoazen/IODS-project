...
dplyr::select(lrn14, gender, Age) #from breakout room 
lrn14 %>% dplyr::select(gender, Age) #from breakout room 
lrn14 |> dplyr::select(gender, Age) #from breakout room 
...
p3
# add a main title
p4 <- p3+ ggtitle("Relation Between the Attitide and Exam Points")+
...
# create a regression model with multiple explanatory variables
my_model2 <- lm(points ~ b, data = learning2014)

# draw diagnostic plots using the plot() function. Choose the plots 1, 2 and 5
par(mfrow = c(2,2))
plot(my_model2, which=c(1,2,5), col.main="blue")
```
