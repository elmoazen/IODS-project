...
math_por <- inner_join(math, por, by = free_cols)
...
g2 + geom_boxplot() +  ggtitle("Student absences by alcohol consumption and sex")+ theme(plot.title = element_text(hjust = 0.5 , size=15, face="bold", color = "blue"))
